...
const Card = ({title = "Default Title", subTitle = "Some quick example text to build on the card title and make up the bulk of the card's content.", buttonText= "Default Button"}) => {
    return(
